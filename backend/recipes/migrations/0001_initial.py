# Generated by Django 3.2.3 on 2024-12-11 07:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooking_time', models.PositiveSmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Минимальное время - 1'), django.core.validators.MaxValueValidator(32767, 'Максимальное время - 32767')], verbose_name='Время приготовления (мин.)')),
